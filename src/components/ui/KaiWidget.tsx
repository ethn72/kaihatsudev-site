...
export function KaiWidget() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-[9999] sm:bottom-6 sm:right-6">
      {open && (
          <div
            className="animate-pop-in fixed bottom-0 right-0 flex h-[85dvh] w-screen flex-col border border-hai bg-sumi sm:absolute sm:bottom-16 sm:right-0 sm:h-[650px] sm:max-h-[80dvh] sm:w-[420px]"
            role="dialog"
